...
// Called every time thread_buffer_size is reached in a worker thread.  Append block and dispatch GrB thread if buffer full.
...
static libtrace_packet_t *per_packet( libtrace_t *trace, libtrace_thread_t *t, void *global, void *tls, libtrace_packet_t *packet )
{
