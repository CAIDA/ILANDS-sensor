...
#           |- analysis.py
#           |- analytics.py
#           |- GraphChallenge_analyses_serial_alt.py (this file)
#           |-...
...
if tar_filepath_prefix is None:
    tar_filepath_prefix = "./../data/tar/2024/10/28/"

# generate file list assuming directory structure of tar_filepath_prefix/directory/grbs.tar
file_list = []
for directory in os.listdir(tar_filepath_prefix):
    file_list.append(tar_filepath_prefix + directory)
